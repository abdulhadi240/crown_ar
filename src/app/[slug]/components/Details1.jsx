...
const Details = ({course}) => {
  ...
  const [currentComponent, setCurrentComponent] = useState(<Summary summary={course}/>);
  ...
  const handleSelect = (newSelection) => {
    ...
    setTimeout(() => {
      ...
      setCurrentComponent(newSelection === 'Summary' ? <Summary summary={course}/> : <Summary summary={course}/>);
