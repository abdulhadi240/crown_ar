  ...
  return (
    <div>
      <div className="container mx-auto md:p-4">
        ...
        <div>
        <div className="">
        <h1 className="flex justify-center mt-8 mb-8 text-2xl font-bold md:block md:mx-20">Most Popular Vacancies</h1>
        ...
        <div className="flex items-center justify-between mx-10 mt-8 ">
          ...
          <h1 className="text-[#0a65cc] text-xs border-[1px] border-[#0a65cc] p-2">View All</h1>
        </div>
