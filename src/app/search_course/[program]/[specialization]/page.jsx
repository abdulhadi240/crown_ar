...
import { GetCategory } from "@/actions/server";
...
export async function generateMetadata({ params }) {
  const product = await fetch(`${process.env.BACKEND_URL}/specializations/${params.specialization}`,{
    headers : {
  ...
  return {
    ...
    openGraph: {
        ...
        url: `https://client-academy.vercel.app/search_course/${params.program}/${params.specialization}`,
...
const Page = async ({params}) => {
  ...
  const data = await fetch(`${process.env.BACKEND_URL}/courses/${params.specialization}/specializations`,{
    headers: {
