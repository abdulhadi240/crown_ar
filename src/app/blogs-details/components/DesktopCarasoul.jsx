...
export default class DesktopCarasoul extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentIndex: 0,
  ...
  render() {
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-4 mt-10 mb-10 overflow-hidden text-center max-w-8xl ">
        {/* Carousel Component */}
        <Carousel
        ...
        >
          {/* Slide 1 with cities */}
          <div className="flex justify-center max-w-6xl gap-4 pb-4 pl-4 mx-auto text-start">
          <Course_card/>
          <Course_card/>
          <Course_card/>
          <Course_card/>
