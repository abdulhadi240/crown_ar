...
const City = ({
  ...
  const jsonLdData = {
    ...
    "itemListElement": (filteredCourses || []).map((course, index) => ({
        ...
        "item": {
            "@type": "Course",
            "name": course?.name || "دورة غير مسماة", // Unnamed Course
            "description": course?.description || "لا يوجد وصف متاح.", // No description available
            "url": `https://ar.clinstitute.co.uk/${params || "default-category"}/${course?.specialization_slug || "default-specialization"}/${course?.slug || "default-course"}`,
            "provider": {
                "@type": "Organization",
            ...
            "image": {
                "@type": "ImageObject",
                "url": course?.image || "https://ar.clinstitute.co.uk/Logocrown.webp"
            },
            "hasCourseInstance": {
                "@type": "CourseInstance",
                "courseMode": "Onsite", // You might want to translate this if needed, e.g., "حضوري"
                "courseWorkload": "PT22H", // This is likely standard, but you might want to consider Arabic numerals if needed.
                "courseSchedule": {
                    "@type": "Schedule",
                    "duration": "P1W", // This is likely standard, but you might want to consider Arabic numerals if needed.
                    "repeatCount": "1", // This is likely standard, but you might want to consider Arabic numerals if needed.
            ...
            "offers": {
                ...
                "price": course?.price || "3000", // You might want to consider Arabic numerals if needed.
                "priceCurrency": "GBP", // Currency codes are usually standard.
                "availability": "https://schema.org/InStock", // This is likely standard.
                "validFrom": (course?.available_dates?.length > 0 && course?.available_dates[0]?.date) || "2025-01-01" // Date format is generally standard.
            }
        }
    }))
  };
  ...
  return (
    <>
      ...
      <Design
    icon_white
    image={"/image_consult.png"}
    center
    input={false}
    image_height={false}
    search_height={true}
    search
    dir="rtl" // Add RTL direction to the main Design component
>
    <div>
        <SectionTitle1
            title="الدورات حسب" // Courses By
            highlight={slug}
            dir="rtl" // RTL for SectionTitle1 as well
        />
    </div>
    <div className="relative flex items-center justify-center">
        <div className="relative flex flex-col items-center w-full max-w-4xl p-6 bg-opacity-90 rounded-lg md:p-8" dir="rtl"> {/* RTL for the main content div */}
            <div className="w-full mb-4">
                <div className="flex items-center p-2 bg-white rounded-md shadow-md md:p-3">
                    <input
                        ...
                        dir="rtl" // RTL for the input field
                    />
                    <button
    ...
    <article className="text-end max-w-4xl" dir="rtl"> {/* RTL and text-end for the article */}
        {/* Header */}
