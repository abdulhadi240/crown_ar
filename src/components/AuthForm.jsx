    ...
    <div className="bg-white p-8 rounded-xl shadow-lg w-[600px] sm:w-[360px] text-sm -mt-16">
      ...
      <form className="flex flex-col gap-4 mt-6" onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col">
          ...
          {errors.username && <p className="text-red-500 text-xs ml-3">{errors.username.message}</p>}
        </div>
        ...
        <div className="flex flex-col">
          ...
          {errors.password && <p className="text-red-500 text-xs ml-3">{errors.password.message}</p>}
        </div>
        ...
        <div className="flex justify-between text-xs text-gray-500">
          ...
          <a href="/forgot-password" className="hover:text-primary">Forgot Password?</a>
        </div>
