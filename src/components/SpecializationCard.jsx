...
const SpecializationCard = ({ title }) => {
  return (
    <div className="flex flex-col  items-center justify-center text-center bg-white group-hover:transition-colors rounded-lg group shadow-md sm:w-40 w-32  h-32 hover:bg-[#152765] hover:text-white"> {/* Reduced padding */}
